...
RSpec.describe Shopper::CartController, type: :controller do
  ...
  describe 'GET #add_product' do
    context 'valid params' do
      it 'renders js' do
        expect do
          post '/cart/add_product', params: { type: 'book', id: 1 }, xhr: true
    ...
    context 'invalid params' do
      it 'redirect via js' do
        expect do
          post :add_product, params: { type: 'book', id: 300 }, xhr: true
        end.not_to change { Shopper::OrderItem.count }
